...
Gem::Specification.new do |s|
  ...
  s.files = ["CHANGELOG.rdoc", "MIT-LICENSE", "Manifest.txt", "README.rdoc", "Rakefile", "init.rb", "lib/authlogic_oauth.rb", "lib/authlogic_oauth/acts_as_authentic.rb", "lib/authlogic_oauth/helper.rb", "lib/authlogic_oauth/oauth_process.rb", "lib/authlogic_oauth/session.rb", "lib/authlogic_oauth/version.rb", "lib/oauth_callback_filter.rb", "test/acts_as_authentic_test.rb", "test/fixtures/users.yml", "test/lib/user.rb", "test/lib/user_session.rb", "test/session_test.rb", "test/test_helper.rb"]
